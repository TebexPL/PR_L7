...
class Posts extends Component {
  ...
  render(){
    ...
    return (
      <React.Fragment>
            <PostsTable items={posts} onDelete={this.handleDelete} sortIcon={this.renderSortIcon} onSort={this.handleSort}/>
            <Pagination itemsCount={items.length} pageSize={this.state.pageSize} currentPage={this.state.currentPage} onPageChange={this.handlePageChange}/>
      </React.Fragment>
